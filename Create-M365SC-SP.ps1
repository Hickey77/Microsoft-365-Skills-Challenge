...
Add-PnPField -List "Incentives" -DisplayName "Asset" -InternalName "Asset" -Type Text -AddToDefaultView
Add-PnPField -List "Incentives" -DisplayName "Diff" -InternalName "Diff" -Type Number -AddToDefaultView
...
Add-PnPListItem -List "Incentives" -Values @{"Title" = "Teams"; "Diff"="4"}
Add-PnPListItem -List "Incentives" -Values @{"Title" = "Office Basics"; "Diff"="5"}
Add-PnPListItem -List "Incentives" -Values @{"Title" = "Outlook"; "Diff"="6"}
Add-PnPListItem -List "Incentives" -Values @{"Title" = "OneDrive"; "Diff"="7"}
Add-PnPListItem -List "Incentives" -Values @{"Title" = "SharePoint"; "Diff"="8"}
Add-PnPListItem -List "Incentives" -Values @{"Title" = "Yammer"; "Diff"="9"}
Add-PnPListItem -List "Incentives" -Values @{"Title" = "Accessibility"; "Diff"="10"}
